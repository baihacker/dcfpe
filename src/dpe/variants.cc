...
namespace dpe {
VariantsReaderImpl::VariantsReaderImpl(const Variants& variants)
    : variants(variants) {}

VariantsReaderImpl::~VariantsReaderImpl() {}

int VariantsReaderImpl::size() const { return variants.element_size(); }
...
const Variants& VariantsBuilderImpl::getVariants() const { return variants; }
